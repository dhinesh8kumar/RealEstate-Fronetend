...
export default function Hero() {
  ...
  <div className="row gx-3">
    <div className="col">
     <div className="p-3 rect1"><img  style={{width:"150px", height:"150px"}}
                ...
                <div>
                  <p>
                    Lorem ipsum dolor sit amet consectetur. Egestas elementum quam
                    suspendisse vitae urna mi aliquet. Arcu tincidunt suspendisse
                    est mi. Vulputate ut quis aliquam quam tincidunt luctus
                    dignissim. Ut lacus elementum ultrices at diam.
                  </p>
                  <div className="name">
                    <p>Dhinesh,USA</p>
                  </div>
